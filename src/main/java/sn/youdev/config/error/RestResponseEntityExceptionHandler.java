        ...
        extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<?> NotFoundException(Exception e){
        return jsonResponse(false,e.getClass().getSimpleName(),404,e.getMessage());
    }
    @ExceptionHandler(EntreeException.class)
    public ResponseEntity<?> entreeException(EntreeException e){
        return jsonResponse(false,e.getClass().getSimpleName(),400,e.getMessage());
    }
...
//    @ExceptionHandler(MethodArgumentNotValidException.class)
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return jsonResponse(false,errors,400,"Erreur validation");
    }
